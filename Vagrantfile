...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :pxeclient do |pxeclient|
    ...
    pxeclient.vm.provider :libvirt do |domain|
      ...
      domain.cmd_line = "console=tty0 console=ttyS0 ip=dhcp METAL_CORE_URL=http://192.168.121.110:4242 IMAGE_URL=http://192.168.121.1:4711/images/os/alpine/3.8/img.tar.lz4"
