...
ENV STORCLI_VERSION=7.8-007.0813.0000.0000 \
	...
	INTEL_FIRMWARE=https://downloadmirror.intel.com/25791/eng/XL710_NVMUpdatePackage_v6_80_Linux.tar.gz
WORKDIR /work
RUN set -ex \
 ...
 && wget -q ${INTEL_FIRMWARE} -O intel.tgz \
 && apt-get update \
...
COPY --from=storcli-builder /work/intel /work/intel
